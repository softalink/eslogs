...
impl FilterPatternMatch {
    fn match_column_generic(&self, br: &mut BlockResult, bm: &mut Bitmap, r: ColRef) {
        ...
        bm.for_each_set_bit(|idx| pm.matches(to_unsafe_string(&values[idx])));
    }
}
        ...
        match ch.value_type {
            ...
            ValueType::UINT8 => {
                ...
                visit_values(bs, &ch, bm, |v| {
                    ...
                    pm.matches(to_unsafe_string(&bb))
                });
            }
            ValueType::UINT16 => {
                let pp = bs.part_path();
